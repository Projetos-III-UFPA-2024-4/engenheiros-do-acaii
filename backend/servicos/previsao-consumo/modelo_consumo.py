# -*- coding: utf-8 -*-
"""Modelo previsão de consumo.ipynb
...
# # Carregar o dataset (ajuste o nome do arquivo conforme necessário)
...
modelo = Prophet()
# modelo.add_seasonality(name="diario", period=24, fourier_order=10)  # Padrão diário
# modelo.add_seasonality(name="semanal", period=24*7, fourier_order=5)  # Padrão semanal
modelo.fit(train)
